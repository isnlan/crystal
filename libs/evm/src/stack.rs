...
use evm::executor::stack::{Accessed, StackState, StackSubstateMetadata};
...
#[derive(Clone, Debug)]
pub struct CrystalStackSubstate<'config> {
	metadata: StackSubstateMetadata<'config>,
	parent: Option<Box<CrystalStackSubstate<'config>>>,
	logs: Vec<Log>,
...
impl<'config> CrystalStackSubstate<'config> {
...
#[derive(Clone, Debug)]
pub struct CrystalStackState<'backend, 'config, B> {
	backend: &'backend B,
	substate: CrystalStackSubstate<'config>,
}

impl<'backend, 'config, B: Backend> Backend for CrystalStackState<'backend, 'config, B> {
...
impl<'backend, 'config, B: Backend> StackState<'config> for CrystalStackState<'backend, 'config, B> {
...
impl<'backend, 'config, B: Backend> CrystalStackState<'backend, 'config, B> {
